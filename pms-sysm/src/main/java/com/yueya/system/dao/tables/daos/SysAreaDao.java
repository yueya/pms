...
@Repository
public class SysAreaDao extends BaseDao<SysAreaRecord, SysAreaDO, Long> {
     ...
     */
    @Override
    protected Long getId(SysAreaDO object) {
        return object.getId();
    }
     ...
     */
    public List<SysAreaDO> fetchById(Long... values) {
     ...
     */
    public SysAreaDO fetchOneById(Long value) {
