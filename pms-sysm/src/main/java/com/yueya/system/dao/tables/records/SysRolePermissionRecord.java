...
public class SysRolePermissionRecord extends UpdatableRecordImpl<SysRolePermissionRecord> implements Record3<Integer, Integer, ULong> {

    private static final long serialVersionUID = 815082019;
     ...
     */
    @Override
    public Row3<Integer, Integer, ULong> fieldsRow() {
     ...
     */
    @Override
    public Row3<Integer, Integer, ULong> valuesRow() {
     ...
     */
    @Override
    public SysRolePermissionRecord value3(ULong value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public SysRolePermissionRecord values(Integer value1, Integer value2, ULong value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public SysRolePermissionRecord(Integer roleId, Integer permissionId, ULong id) {
        super(SysRolePermission.SYS_ROLE_PERMISSION);
