...
public class SysRolePermissionRecord extends UpdatableRecordImpl<SysRolePermissionRecord> implements Record3<Long, Long, Long> {

    private static final long serialVersionUID = 1034685565;
     ...
     */
    @Override
    public SysRolePermissionRecord values(Long value1, Long value2, Long value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public SysRolePermissionRecord(Long roleId, Long permissionId, Long id) {
        super(SysRolePermission.SYS_ROLE_PERMISSION);
